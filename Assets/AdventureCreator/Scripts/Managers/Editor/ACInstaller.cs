	...
	public class ACInstaller
	{
		...
		public static void DoInstall ()
		{
			...
			if (!gotMenu || !gotNavMesh || !gotBackgroundImage)
			{
				...
				bool canProceed = EditorUtility.DisplayDialog ("Adventure Creator installation", "Adventure Creator requires that the following be defined in your Project Settings:\r\n\r\n" + changesToMake + "\r\nAC can make the necessary changes for you, if you wish. Proceed?", "OK", "Cancel");
				if (canProceed)
				{
					DefineInputs ();
					DefineLayers ();
